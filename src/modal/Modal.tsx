	...
	return (
		<AnimatePresence mode="wait">
			{showModal && (
				...
				>
					<button className="absolute right-8 top-8 z-50 text-matte-white font-bold p-4 text-xl lg:text-2xl transition-all duration-200 hover:scale-150">
						x
					</button>
					<motion.div
						id="modal-bgImage"
						onClick={(e) => e.stopPropagation()}
						className="realtive rounded-3xl w-11/12 h-[65%] relative mx-auto max-w-7xl "
					>
